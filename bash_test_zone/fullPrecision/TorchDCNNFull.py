...
class mnist(nn.Module):
    ...
    def forward(self, x):
        ...
        if (self.layerGPU==3):
            out3_ = self.layer3(out2.to(device=cuda), output_size=(28,28))
...
class celeba(nn.Module):
    ...
    def __init__(self, layerGPU):
        ...
        if (self.layerGPU==1):
            self.layer1 = nn.ConvTranspose2d(in_channels=128, out_channels=128, kernel_size=(3,3), stride=1, padding=0).to(device=cuda)
        else:
        ...
        if (self.layerGPU==2):
            self.layer2 = nn.ConvTranspose2d(in_channels=128, out_channels=128, kernel_size=(3,3),stride=1, padding=0).to(device=cuda)
        else:
        ...
        if (self.layerGPU==3):
            self.layer3 = nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=(5,5),stride=1, padding=0).to(device=cuda)
        else:
        ...
        if (self.layerGPU==4):
            self.layer4 = nn.ConvTranspose2d(in_channels=64, out_channels=32, kernel_size=(5,5),stride=2, padding=0).to(device=cuda)
        else:
        ...
        if (self.layerGPU==5):
            self.layer5 = nn.ConvTranspose2d(in_channels=32, out_channels=3, kernel_size=(5,5), stride=2, padding=0).to(device=cuda)
        else:
